...
function Laws() {
  return (
    <div>
      <Helmet>
              <title>
                  Law Admission Guidance India | LLB, BA LLB Counselling
              </title>
      
              <meta
                name="description"
                content="
                 Get expert law counselling for LLB, BA LLB & LLM programs. Admission guidance via merit, management & NRI quota in top law colleges across India."
              />
      
              <meta name="robots" content="index, follow" />
               <link
                rel="canonical"
                href="https://sairameducation.in/law"
              />
            </Helmet>
      <Nav/>
    ...
    <section className="py-20">
      <div className="max-w-6xl mx-auto px-6 flex flex-col md:flex-row items-center gap-6">
        <div className="flex-1">
          ...
          Sairam Education & Consultancy Services provides structured counselling and admission guidance for students aspiring to build careers in law and legal studies. Our counselling framework helps students understand different legal education pathways and choose programs aligned with their academic background and career goals.


          </p>
          <br />
          <p className=" mb-4 font-Regular text-[16px] md:text-[18px] text-[#696984] tracking-[0.02em]">We offer admission guidance through merit quota, management quota and NRI quota seats, ensuring a transparent and well-structured admission process across law institutions.</p>
        </div>
...
<p className='font-medium text-[16px] md:text-[20px] text-[#FFFFFF]'>Our Law counselling services include</p>
           <ul className="mt-6">
            {[
              "One-to-one counselling for law and legal studies programs.",
              ...
              "Program selection based on academic background and legal career aspirations.",
  ...
  />
        ...
        <div className="flex-1">
           <ul className="mt-6">
            {[
              "3-Year LLB",
              "5-Year IntegratYed Law Programs",
              "BA LLB",
              "BBA LLB",
              "Other Integrated Law Programs"
            ].map((item, index) => (
            <li key={index} className="flex gap-3 mb-4">
  <span className="flex items-center justify-center w-6 h-6 bg-[#49BBBD] text-white rounded-full shrink-0 self-start mt-[6px]">
    <ChevronRight size={12} />
      ...
      <section className="py-12 px-6 text-[#FFFFFF]">
        <div className="w-full lg:max-w-6xl mx-auto bg-[#49BBBD] rounded-[75px] p-10">
          ...
          <h2 className="text-[32px] font-bold">
            Start Your Journey in Law With Us
          </h2>
          <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-6">
      
            <p className="md:max-w-[70%]  text-[16px] md:text-[20px] font-medium  leading-relaxed">
             Explore suitable law programs and admission pathways with expert guidance.
            </p>
      <Link to="/contact-us">
